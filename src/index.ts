  ...
  pi.on("session_start", async (_event, ctx) => {
    ...
    messageBus.onMessage((msg) => {
      ...
      if (msg.type !== "response") {
        ...
        const instruction = `[pip2p] ${msg.from} sent you a ${msg.type}: "${msg.content}"\nIMPORTANT: You MUST use the send_to_agent or reply_to_agent tool to send your response back to ${msg.from}. Do NOT just reply in this conversation — ${msg.from} cannot see your responses here.`;
